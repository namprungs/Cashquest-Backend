...
export class UserService {
  ...
  getMeProfile(userId: string, termId: string) {
    return this.profileService.getMeProfile(userId, termId);
  }

  updateMyProfileImage(userId: string, profileImageUrl: string | null) {
    return this.profileService.updateMyProfileImage(userId, profileImageUrl);
  }

  getMyCurrentTermId(userId: string) {
    return this.profileService.getMyCurrentTermId(userId);
  }

  getClassroomLeaderboard(userId: string, termId: string, take: number) {
